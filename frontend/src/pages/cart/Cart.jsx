          ...
          {cartItems?.length === 0 ? (
            ...
            <div className="text-center py-24 max-w-md mx-auto space-y-5">
              ...
              <div className="pt-2">
                <Link
                  to="/products"
                  className="inline-flex h-11 items-center justify-center px-6 bg-mauve-600 hover:bg-mauve-700 text-white text-xs uppercase font-bold tracking-widest rounded-lg transition-colors shadow-xs"
                >
                  Explore Products
                </Link>
              </div>
                        ...
                        <div className="flex items-center gap-4 min-w-0 w-full sm:w-auto">
                          ...
                          <div className="min-w-0">
                            <Link
                              ...
                              className="text-sm font-medium text-zinc-900 hover:text-mauve-600 transition-colors block truncate max-w-50 sm:max-w-xs"
                            >
                              {item?.name}
                            </Link>
