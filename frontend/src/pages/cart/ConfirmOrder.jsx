            ...
            <div className="lg:col-span-7 space-y-12">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm text-zinc-700">
                  <p>
                    <span className="text-zinc-400 inline-block w-20">
                      Name:
                    </span>{" "}
                  ...
                  <p>
                    ...
                    <span className="font-mono">{shippingInfo?.phoneNo}</span>
                  </p>
                  <p className="flex items-start">
                    <span className="text-zinc-400 inline-block w-20 shrink-0">
                      Address:
                    </span>{" "}
